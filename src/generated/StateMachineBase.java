...
**/
    ...
    public static final int COMMAND_GUI1Volver = 2;
    public static final int COMMAND_MainOtraVentana = 1;

    protected boolean onGUI1Volver() {
        return false;
    }

    protected boolean onMainOtraVentana() {
        return false;
    }

    protected void processCommand(ActionEvent ev, Command cmd) {
        switch(cmd.getId()) {
            case COMMAND_GUI1Volver:
                if(onGUI1Volver()) {
                    ev.consume();
                    return;
                }
            ...
            case COMMAND_MainOtraVentana:
                if(onMainOtraVentana()) {
                    ev.consume();
                    return;
                }
                break;
